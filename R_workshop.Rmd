...
Let's create a few objects and look at the class R will assign them by default, using functions like `c()` and `class()`. Functions are little programs that do specific things and you'll be using them all the time.
...
1. combine these into a data frame and give them a sensible class 
2. Multiply the CFU column by 1000 and save it as a new column
3. using `str()`, check the class of your data frame columns
...
In this tutorial we'll import a small dataset and familiarise ourselves with a few functions that will help us look at our data.
