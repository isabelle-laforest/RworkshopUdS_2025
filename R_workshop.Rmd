...
. Make a violin plot of the proportion of Mass for each sex state using `geom_violin()`
2. Add the points on top of the violins
3. Add labels
3. Map the shape of the points to the `Year` variable (hint: you can reuse the `aes()` function inside any geom, here's a [reference](https://www.sthda.com/english/wiki/ggplot2-point-shapes))
4. Facet this plot by Method
