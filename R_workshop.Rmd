...
1. Correct the Method variable so that `pole` is replaced by `Pole` (because we find both!)
2. Dynamically create a vector containing the top 3 most common capture methods
3. Create a density ridge plot showing the distribution of masses for each age, in a way that allows us to distinguish each method and compare both sexes.
