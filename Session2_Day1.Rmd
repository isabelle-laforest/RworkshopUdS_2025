...
#plot(total.area~Treatement,data=tomato) #this is the same
plot(tomato$total.area~tomato$Infection)
plot(tomato$total.area~tomato$Infection)
```
...
```{r log}
plot(log(tomato$total.area)~tomato$Infection)
plot(I(tomato$total.area/100000)~tomato$Infection)
```
